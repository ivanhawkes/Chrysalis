...
//			Character.m_actorState.durationOnGround += prePhysicsEvent.m_frameTime;
//
...
//				float durationInAir = Character.m_actorState.durationInAir;
//				durationInAir += prePhysicsEvent.m_frameTime;
//				Character.m_actorState.durationInAir = durationInAir;
//
...
//			else
//			{
//				Character.m_actorState.durationInAir = 0.0f;
//			}
//
...
//		{
//			const SActorPrePhysicsData& prePhysicsEvent = static_cast<const SStateEventActorMovementPrePhysics&> (event).GetPrePhysicsData ();
//			Character.m_actorState.durationInAir += prePhysicsEvent.m_frameTime;
//

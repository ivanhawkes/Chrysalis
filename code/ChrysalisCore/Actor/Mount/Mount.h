...
public:
	...
	const char* GetActorClassName() const override { return "CMount"; };

	/* You must override CActor for correct behaviour. */
	ActorClass GetActorClass() const override { return EActorClassType::EACT_MOUNT; };

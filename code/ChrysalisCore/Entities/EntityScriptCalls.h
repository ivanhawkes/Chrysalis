/**
 \file	d:\Chrysalis\Source\Chrysalis\Entity\EntityScriptCalls.h

 Utility functions relating to script operations for entities.
 */
...
//	bool result = false;
//
//	if ((pEntity != nullptr) && (pScriptTable != nullptr))
//	{

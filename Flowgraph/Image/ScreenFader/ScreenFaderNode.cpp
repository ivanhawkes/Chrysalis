...
//		m_duration = fDuration > FLT_EPSILON ? fDuration : 0.0f;
//		m_curTime = 0.0f;
//		m_direction = -1;
//		m_bActive = true;
...
//		if (ser.IsReading())
//		{
//			// In case we were playing before the fader is stopped on load, but still we need to activate outputs.
//			// This MUST NOT be done in serialize but in ProcessEvent.
//			if (m_bPlaying)
//			{

...
// TODO: Clean this up, make it part of the class.
...
{
	// TODO: I think this is wrong. It's meant to be handled by the ProcessEvent function instead. No time
	// to test this tonight, it will have to wait.
...
void CLedgeObject::RegisterEvents()
{

/**
\file d:\CRYENGINE\Code\ChrysalisSDK\EntitySensing\IEntityAwarenessComponent.h

Declares the IEntityAwarenessComponent interface.
**/
#pragma once
...
struct IEntityAwarenessComponent : ISimpleExtension
{
	/**

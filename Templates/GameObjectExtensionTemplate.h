...
\sa	CGameObjectExtensionHelper&lt;CGameObjectExtensionTemplate, IGameObjectExtension&gt;
\sa	IGameObjectView
*/
class CGameObjectExtensionTemplate : public CGameObjectExtensionHelper <CGameObjectExtensionTemplate, IGameObjectExtension>
{
public:
	// ***
	...
	*/
	virtual ~CGameObjectExtensionTemplate();
};
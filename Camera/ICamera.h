...
struct ICamera : public ISimpleExtension
{
	...
	*/
	...
	operation in the forward direction using camera space. Since it's primary use will be for weapon targeting
	it should cast a reasonable distance and hit living creatures, terrain, and physical entities.

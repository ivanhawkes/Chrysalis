...
// previously hard-coded value in CBoidAvian::ClampSpeed()
...
void CFlock::CreateBoids(SBoidsCreateContext &ctx)
{
	...
	// TODO: ILH - broken for now until I investigate this game cache and bring the code over. The assumption is that it
	// will just be slower to load the models for now.

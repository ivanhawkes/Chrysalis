/**
\file	d:\Chrysalis\Source\Chrysalis\Game\Physics\GamePhysicsSettings.h

Declares the game physics settings class.
*/
#pragma once
...
public:
	...
	/** This instance's default constructor. Used to call the Init() method. */
